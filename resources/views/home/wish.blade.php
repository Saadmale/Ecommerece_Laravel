...
<form method="POST" action="{{ route('login') }}" class="col-10">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark ">
      ...
      <div class="mb-5 py-3 bg-light">
        <div class="container">
        <h5>Home / <span style="color: #ff4d6d">My WishList</span></h5>
      </div>
      </div>
      ...
      <div class="container d-flex justify-content-between mt-4 mb-5">
        <div class="card shadow-lg" style="width: 10rem; height:100%;">
            ...
            <a style="text-decoration: none; color:#ff4d6d;" class="my" href="{{ route('wish') }}"><i style="margin-right:5px;" class="fa-solid fa-heart"></i>WishList</a><br>
                        ...
                        @if(session('wish'))
                         ...
                         @php $total += $details['price'] @endphp
                                ...
                                <tr rowId="{{ $id }}">
                                    ...
                                    <td class="actions">
                                        <a class="btn btn-outline-danger btn-sm remove-product"><i class="fa-solid fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            @else
                            <td></td>
                            <td>
                                <img style="margin-left: 330px" src="/image/wishlist.png" width="80px" alt=""> <h6 style="text-align: center">Your Wishlist is Empty.</h6>
                            </td>

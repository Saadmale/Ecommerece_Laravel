...
<div style="width: 500px; background-color:white" class="container shadow-lg d-flex justify-content-center mt-5 p-5 mb-5">

    <form action="{{ route('store') }}" method="POST" class="col-11">
        ...
        <div class="input-group mb-3">
            ...
            <span class="input-group-text" id="icon"><img style="cursor: pointer" src="image/eye-close.png" width="20px" ></span>
        </div>

        <div class="mb-3">
            <input type="password" name="confirmpassword" placeholder="Confirm_Password" class="form-control @error('confirmpassword') is-invalid @enderror">

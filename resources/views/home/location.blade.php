...
<form method="POST" action="{{ route('login') }}" class="col-10">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark ">
      ...
      <div class="mb-5 py-3 bg-light">
        <div class="container">
        <h5>Home / <span style="color: #ff4d6d">Location</span></h5>
    </div>
      </div>
      ...
      <div class="container d-flex justify-content-between mt-4 mb-5">
        <div class="card shadow-lg" style="width: 10rem; height:100%;">
            ...
            <a style="text-decoration: none; color:#ff4d6d;" class="my" href="{{ route('mylocation') }}"><i style="margin-right:10px" class="fa-solid fa-location-dot"></i>Location</a><br>
            ...
            <a style="text-decoration: none; color:black;" class="my" href=""><i style="margin-right:7px" class="fa-solid fa-list"></i>Add Category</a><br>
        ...
        <div class="card shadow-lg" style="width: 50rem; margin-right:250px;">
            <div class="card-body">
              <h4 class="">My Location</h4>
              <h6 class=" mt-3">My Address & Location</h6>
              <hr>
              <div class="d-flex justify-content-between">
              <img class="shadow-sm" src="/image/google-map.jpg" width="300px" height="100%" alt="">

              <form style="border-radius: 20px" action="" class="col-7 shadow-lg p-4">
                <input style="background-color:#dee2e6" type="text" class="form-control" placeholder="Your Location" name="" id="">

                <div class="row">
                    <div class="col">
                      <input style="background-color:#dee2e6" type="text" class="form-control mt-3" placeholder="City" aria-label="First name">
                    </div>
                    <div class="col">
                      <input style="background-color:#dee2e6" type="text" class="form-control mt-3" placeholder="State" aria-label="Last name">
                    </div>

                    <div class="col">
                        <input style="background-color:#dee2e6" type="text" class="form-control mt-3" placeholder="Zip" aria-label="Last name">
                      </div>
                  </div>
                  <textarea style="background-color: #dee2e6" type="text" class="form-control mt-3" placeholder="Your Message"  cols="30" rows="5"></textarea>

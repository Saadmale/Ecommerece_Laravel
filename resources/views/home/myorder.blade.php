...
<form method="POST" action="{{ route('login') }}" class="col-10">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark ">
      ...
      <div class="mb-5 py-3 bg-light">
        <div class="container">
        <h5>Home / <span style="color: #ff4d6d">My Order</span></h5>
    </div>
      </div>
      ...
      <div class="container d-flex justify-content-between mt-4 mb-5">
        <div class="card shadow-lg" style="width: 10rem; height:100%;">
            ...
            <a style="text-decoration: none; color:#ff4d6d;" class="my" href="{{ route('myorder') }}"><i style="margin-right:8px" class="fa-solid fa-bag-shopping"></i>My Order</a><br>
        ...
        <div class="card shadow-lg" style="width: 65rem; margin-left:100px">
            <div class="card-body">
              <h4 class="">My Orders</h4>
              <h6 class=" mt-3">Add my Orders</h6>
              <hr>
                  <table class="table table-striped">
                    <tr style="background-color:#c9184a; color:white">
                        <th>image</th>
                        <th>title</th>
                        <th>Quantity</th>
                        <th>price</th>
                    ...
                    <tr>
                        <td>
                            <img src="/public/image/{{ $data->image }}" width="60px" alt="">
                        </td>
                        <td>{{ $data->title }}</td>
                        <td>{{ $data->quantity }}</td>
                        <td>{{ $data->price }}</td>
                        ...
                        <td>
                            ...
                            <a class="btn btn-danger" href="{{ route('delete_product', $data->id) }}">Remove</a>
                        </td>
                    </tr>
                    @endforeach

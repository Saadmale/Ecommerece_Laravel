...
<form method="POST" action="{{ route('login') }}" class="col-10">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark ">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li style="margin-left:550px; margin-top:3px" class="nav-item">
      ...
      <div class="mb-5 py-3 bg-light">
        <div class="container">
        <h5>Home / <span style="color: #ff4d6d">My Profile</span></h5>
    </div>
      </div>
      ...
      <div class="container d-flex justify-content-between mt-4 mb-5">
        <div class="card shadow-lg" style="width: 10rem; height:100%;">
            <div class="card-body">
            <a style="text-decoration: none; color:#ff4d6d; " class="my" href="{{ route('home') }}"><i style="margin-right:8px" class="fa-solid fa-user-tie"></i>My Profile</a><br>
            ...
            <a style="text-decoration: none; color:black;" class="my" href="{{ route('cart') }}"><i style="margin-right:5px" class="fa-solid fa-cart-shopping"></i>My Cart</a><br>
        ...
        <div class="card shadow-lg" style="width: 50rem; margin-right:250px;">
            <div class="card-body">
              <h4 class="">My profile</h4>
              <div class="container">
                <img src="image/user.png" width="70px" alt="">
                <h3 style="margin-top:5px; color:#ff4d6d; margin-left:5px">{{Auth::user()->name}}</h3>
            </div>
              ...
              <div class="mb-3">
                ...
                <input style="background-color:#ced4da" type="text" value="{{ Auth::user()->name }}" class="form-control">
              </div>

              <div class="mb-3">
                <label for="">Email</label>
                <input style="background-color:#ced4da" type="email" value="{{ Auth::user()->email }}" class="form-control">
              </div>

              <div class="mb-3">
                <label for="">Address</label>
                <textarea style="background-color:#ced4da; " name="address" class="form-control" placeholder="Enter Your Address" cols="30" rows="5"></textarea>
              </div>

              <div class="row">
                <div class="col">
                    <label class="mb-2" for="">Birthday Date</label>
                  <input style="background-color:#ced4da" type="date" class="form-control" placeholder="First name" aria-label="First name">
                </div>
                <div class="col">
                    <label class="mb-2" for="">Pin Code</label>
                  <input style="background-color:#ced4da" type="text" class="form-control" placeholder="19114" aria-label="Last name">
                </div>
              </div>
              ...
              <div class="container d-flex justify-content-between">
                <p>Electronic mail (or e-mail or email) is an Internet service.<br> that allows people who have an e-mail address.<br> (accounts) to send and receive. </p>
                <div style="margin-right:80px" class="mb-3">
                    <label for="">Email - Address</label>
                    <input style="color:green; background-color:#ced4da" type="email" value="{{ Auth::user()->email }}" class="form-control">
                  </div>
              </div>

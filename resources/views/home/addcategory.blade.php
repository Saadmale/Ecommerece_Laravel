...
<form method="POST" action="{{ route('login') }}" class="col-10">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark ">
      ...
      <div class="mb-5 py-3 bg-light">
        <div class="container">
        <h5>Home / <span style="color: #ff4d6d">Add Category</span></h5>
    </div>
      </div>
      ...
      <div class="container d-flex justify-content-between mt-4 mb-5">
        <div class="card shadow-lg" style="width: 10rem; height:100%;">
            ...
            <a style="text-decoration: none; color:#ff4d6d;" class="my" href="{{ route('add_category') }}"><i style="margin-right:7px" class="fa-solid fa-list"></i>Add Category</a><br>
        ...
        <div class="card shadow-lg" style="width: 50rem; margin-right:250px;">
            <div class="card-body">
              ...
              <h6 class=" mt-3">Add your Category</h6>
              <hr>
              <form action="{{ route('store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                    <label for="">Title</label>
                    <input type="text" value="{{ old('title') }}" class="form-control @error('title') is-invalid @enderror" name="title" placeholder="Product Title">
                    @error('title')
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" value="{{ old('description') }}"  class="form-control @error('description') is-invalid @enderror" id="" placeholder="Description" cols="30" rows="5"></textarea>
                    @error('description')
                    <span class="text-danger">
                        {{ $message }}
                    </span>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" value="{{ old('quantity') }}"  min="1" max="100" name="quantity" placeholder="0/100" class="form-control @error('quantity') is-invalid @enderror">
                    @error('quantity')
                    <span class="text-danger">
                        {{ $message }}
                    </span>
                ...
                <div class="mb-3">
                    ...
                    <input type="file" name="image" class="form-control @error('image') is-invalid @enderror" placeholder="Product Title">
                    @error('image')
                    <span class="text-danger">
                        {{ $message }}
                    </span>
                ...
                <button style="submit" class="btn btn-primary">Add Product</button>
              </form>
